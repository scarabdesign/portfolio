...
function PointItem({ title, good }: PointItemProps) {
  ...
  return (
    <div className="point_item">
      <span className="point_item_list">
        {points.map((item, ind) => (
          <i className={item.name} key={ind}></i>
        ))}
      </span>
  ...
  return (
    <div className="mycontact">
      <div>
        ...
        <a href="mailto:scarabdesign@gmail.com">scarabdesign@gmail.com</a>
      </div>
      <div>
        <i className="fa-solid fa-phone"></i>{" "}
        <a href="tel:5415050723">(541) 505-0723</a>
      </div>
      <div>
        <i className="fa-solid fa-location-dot"></i> <span>Eugene, OR</span>
      </div>
      <div>
        <i className="fa-brands fa-linkedin"></i>{" "}
        <a href="https://www.linkedin.com/in/sean-hankins" target="_blank">
          linkedin.com/in/sean-hankins
        </a>
      </div>
      <div>
        <i className="fa-brands fa-github"></i>{" "}
        <a href="https://github.com/scarabdesign" target="_blank">
          github.com/scarabdesign
        </a>
      </div>
    </div>
  );
    ...
    <Section name="skills">
      <div className="split_container">
        <div className="right_pane">
          ...
          <PointItem title="MSSQL" good={4} />
          <PointItem title="SQLite" good={4} />
          <PointItem title="MySQL" good={3} />
          <PointItem title="PostgreSQL" good={3} />
    ...
    <div className="body">
      <Section name="objective">
        <span className="textstyle">
          Seeking a challenging position in a progressive environment where I
          can utilize and enhance my skills as a computer programmer /
          application designer individually or in a team environment.
        </span>
      </Section>
      <Section name="experience">
        ...
        >
          <span>
            Part of a large team of developers designing and coding a software
            distribution platform, responsible for:
          </span>
          <ul>
            <li>
              Back-end development in C# .NET and MSSQL Database with Front-end
        ...
        >
          ...
          <ul>
            <li>
              A suite of mobile applications to support fire fighters and
              first-responders in the field (Xamarin: Android/iOS/Windows)
            </li>
            <li>
              An extensive WebSocket / RESTful API to support the mobile suite
              with live emergency incident data and tracking (C#, .NET)
            </li>
            <li>
              A Web based interface for higher level aspects of managing
              personnel and apparatus of fire/medical agencies (ASP.NET MVC)
            </li>
            <li>
              API tools for downloading and parsing third party wildfire/hotspot
              datasets for on-map visualization (Python, C#, others)
            </li>
          </ul>
        </SubDivider>
        <SubDivider
        ...
        >
          ...
          <ul>
            <li>
              Complex web application interfaces focusing on big data
              visualization and IoT (JavaScript, HTML, Node.js, Bing Maps,
              Google Maps, OpenStreetMap)
            </li>
            <li>
              A multi-platform mobile application that communicates to vehicles
              with OBD2 and tracks location (Python, Node.js)
            </li>
            <li>
              Complex web application interfaces and API focusing on voter data,
              walking list creation and data analytics (JavaScript/JQuery)
            </li>
            <li>
              iOS applications used to view, gather, map and synchronize data
              with system servers while mobile (Objective C)
            </li>
          </ul>
        </SubDivider>
        ...
        <div className="split_container">
          <div className="right_pane">
            ...
            >
              <ul>
                <li>
                  LeadFoot Logistics: User and admin management application
                </li>
                <li>
                  Everyone Orchestra: Design, coding, maintaining web presence
                </li>
                <li>
                  Vision for Intact Ecosystems & Watersheds: Design, coding,
                  maintaining web presence
                </li>
                <li>
                  Rainbow Garden School: Design, coding, maintaining web
                  presence
                </li>
                <li>
                  Construction News Net: Shopping Cart system, with user and
                  admin management
                </li>
              </ul>
            </SubDivider>
          ...
          <div className="left_pane">
            ...
            >
              <ul>
                <li>
                  Web development for a large company, designing, coding and
                  implementing web applications and systems to facilitate
                  manufacturing and sales of motor coaches
                </li>
              </ul>
            </SubDivider>
            <SubDivider
            ...
            >
              <ul>
                <li>
                  Web development for a high traffic 2000+ page informational
                  site for a non-profit international organization. Graphic
                  design, applications programming and presentation
                </li>
              </ul>
            </SubDivider>
            <SubDivider
